    ...
    <div class="shop-grid">
      <article v-for="(project, index) in projects" :key="project.url" class="shop-card"
        ...
        <div class="shop-card-top">
          <span class="shop-icon"><img src="/icons/work.svg" alt="" /></span>
        ...
        <div class="shop-actions">
          <a v-if="project.site" :href="project.site" target="_blank" rel="noopener">访问站点 <img src="/icons/arrow-outward.svg" alt="" /></a>
          <a v-if="project.repo" :href="project.repo" target="_blank" rel="noopener">项目仓库 <img src="/icons/arrow-outward.svg" alt="" /></a>
          <a v-if="!project.site && !project.repo" :href="project.url">查看详情 <img src="/icons/arrow-forward.svg" alt="" /></a>
        </div>
      </article>
    </div>
